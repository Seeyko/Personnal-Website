...
Le problème ? **Tu ne sais pas pourquoi tu fais ce que tu fais.** La décision a été prise ailleurs, dans une autre salle, par d'autres personnes. Toi, tu exécutes. Et si la feature ne marche pas, si personne ne l'utilise, si elle résout le mauvais problème — ce n'est pas ton problème. Tu as livré 100% du sprint, mission accomplie.

Sauf que non. Parce que livrer 100% des sprints, ce n'est pas la même chose qu'avoir un **impact réel** sur les utilisateurs. Et quand tu codes pendant des mois sans jamais voir cet impact, sans jamais parler aux gens qui utilisent ce que tu construis, ça devient creux. Ça devient un job comme un autre.
...
Le cycle "problème → fix" est direct. Pas de téléphone arabe entre 4 départements.

## Ce qu'un dev senior veut vraiment

Je me suis rendu compte que ce qui me motive — et ce qui motive beaucoup de développeurs seniors que je connais — ce n'est pas juste coder. C'est :

### Ownership
Être **responsable** d'un bout de produit. Pas juste responsable du code, mais du **résultat utilisateur**. Si ça marche, c'est grâce à moi. Si ça ne marche pas, c'est à moi de fixer. Pas de "c'est pas mon problème".

### Impact
Savoir que ce que je construis **change vraiment** quelque chose pour les gens qui l'utilisent. Pas des features marketing juste pour dire qu'on a fait quelque chose. Des vrais game-changers.

### Autonomie
Avoir la liberté de **décider comment** résoudre un problème. Pas juste appliquer une solution déjà choisie par quelqu'un d'autre. Définir mes objectifs trimestriels, mes priorités, mes méthodes.

### Vision
Comprendre **où on va**. Pourquoi on fait ce qu'on fait. Comment ça s'inscrit dans une roadmap claire et cohérente. Pas des changements de direction toutes les deux semaines.

Le problème ? Beaucoup d'organisations ne sont pas structurées pour offrir ça. Elles sont structurées pour **contrôler** : sprints, story points, vélocité, daily stand-ups, burn-down charts. Des métriques qui mesurent l'activité, pas l'impact.

## L'impact de l'IA sur le métier

L'IA change tout. Pas demain — **maintenant**.
...
Quand on ne fait pas confiance aux devs pour livrer, on ajoute du contrôle. Quand on ajoute du contrôle, on ralentit. Quand on ralentit, on crunch pour rattraper. Quand on crunch, la qualité baisse. Quand la qualité baisse, on perd encore plus confiance. Loop.
...
Mais la confiance sans feedback, c'est du laisser-aller. Donc il faut **du feedback constant** :
- Les utilisateurs utilisent-ils la feature ?
- Est-ce que ça résout leur problème ?
- Quels sont les bugs reportés ?
- Qu'est-ce qui pourrait être amélioré ?

Et surtout : **les développeurs doivent voir ce feedback directement**. Pas filtré par un PM. Pas résumé dans un rapport. Directement. Parce que c'est comme ça qu'on apprend. C'est comme ça qu'on développe une intuition produit.
...
- Écrire du code, oui, mais ce n'est qu'une **partie** du travail
...
Donne-moi un objectif trimestriel, un problème à résoudre, et laisse-moi trouver comment. Pas 15 user stories découpées au millimètre avec des story points et une vélocité cible.

### De la transparence par défaut
Roadmap publique (au moins en interne). Décisions documentées. Données accessibles. Pas de "décisions qui tombent du ciel" sans qu'on comprenne le pourquoi.
...
Mais ça ne marchera que si les organisations évoluent aussi. Que si on casse les silos. Que si on fait confiance. Que si on donne de l'ownership et de la responsabilité.
